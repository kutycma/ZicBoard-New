...
CREATE TABLE `v2_knowledge` (
                                `id` int(11) NOT NULL AUTO_INCREMENT,
                                `id_staff` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                ...
                                PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='知識庫';
...
INSERT INTO `v2_knowledge` VALUES (1,'vi-VN','ID apple','Lấy ID Apple tải shadowsocket','<!--access start--> Nếu muốn kích hoạt tính năng mua gói mới nhìn thấy ID apple vui lòng liên hệ NK Quang qua zalo 0848892333<br><!--access end-->',NULL,1,1701784222,1701870587);
